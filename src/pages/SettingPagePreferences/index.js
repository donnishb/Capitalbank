          ...
          <div className="bg-white_A700 flex flex-col gap-[42px] items-center justify-end p-[30px] sm:px-[20px] rounded-radius25 md:w-[100%] sm:w-[100%] w-[94%]">
            <div className="flex flex-col justify-start mt-[7px] w-[100%]">
              <div className="flex sm:flex-col flex-row sm:gap-[20px] items-start justify-start md:ml-[0] sm:ml-[0] ml-[16px] md:w-[100%] sm:w-[100%] w-[37%]">
                ...
                <div className="flex flex-col gap-[8px] items-center justify-start sm:ml-[0] ml-[61px] md:w-[100%] sm:w-[100%] w-[30%]">
                  <Text
                    className="font-medium text-indigo_600 text-left w-[auto]"
                    variant="body1"
                  >
            ...
            <div className="flex flex-col items-start justify-start w-[100%]">
              <div className="flex md:flex-col sm:flex-col flex-row md:gap-[30px] sm:gap-[30px] items-center justify-between rounded-radius15 w-[100%]">
              ...
              <Button
                className="cursor-pointer font-medium leading-[normal] min-w-[19%] md:ml-[0] sm:ml-[0] ml-[860px] mt-[72px] text-[18px] text-center text-white_A700 w-[max-content]"
