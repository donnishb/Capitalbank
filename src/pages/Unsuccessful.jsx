                  ...
                  <div className="flex flex-col gap-[20px] items-start justify-start md:w-[100%] sm:w-[100%] w-[100%]">
                    ...
                    <div className="bg-white_A700 flex flex-col items-start justify-start p-[27px] sm:px-[20px] rounded-radius25 w-[100%]">
                      <Text
                        ...
                        style={{ color: "red" }}
                      >
                        Hello, due to too many login attempts your account has
                        been suspended from making transactions at the moment
                        please contact customer support/visit the nearest branch
                        for assistance
                      </Text>
                    </div>
                  </div>
