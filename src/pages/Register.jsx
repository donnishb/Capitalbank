...
function Register() {
  ...
  useEffect(()=>{
    ...
    const handleRegister = (e) => {
        ...
        if(inputUser.password===inputUser.confirm_password && inputUser.firstname!==null && inputUser.lastname!==null && inputUser.city!==null && inputUser.address!==null && inputUser.email!==null ){
            navigate("/submitted")
        }
        else{
            e.preventDefault();
    ...
    return ( <>{onLine?( <div>
      ...
      {!(inputUser.email.includes("@")) && inputUser.email.length>0  ? (<span class="inline-flex text-sm text-red-700"> Enter valid email
                ...
                <input onChange={(e)=>{handleChange(e)
                  ...
                  name="password"
                   placeholder="Enter Password" />
                    {inputUser.password.length<7 && inputUser.password.length>0 ? (<span class="inline-flex text-sm text-red-700">Password Must be at least 8 characters 
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                      stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                  </svg></span>): "" }
              ...
              <div class="relative">
                <input onChange={(e)=>{handleChange(e)
                  ...
                  name="confirm_password"
                   ...
                   {inputUser.password!==inputUser.confirm_password ? (<span class="inline-flex text-sm text-red-700">Passwords do not match
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                      stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                  </svg></span>): "" }
              ...
              <button type="submit" onClick={(e)=>{handleRegister(e)}} class="bg-[#002D74] rounded-xl text-white py-2 hover:scale-105 duration-300">Register</button>
            </form>
